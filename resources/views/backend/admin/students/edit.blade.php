                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                               value="{{ old('name', $student->name) }}" required placeholder="Enter student's full name">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" 
                               value="{{ old('email', $student->email) }}" required placeholder="student@email.com">
                        @error('email')
                            <span class="error-text">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="help-text">Min 8 characters. Only fill to change password</small>
                        @error('password')
                            <span class="error-text">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="class" id="class" class="form-control @error('class') is-invalid @enderror" required>
                            ...
                            @foreach (['06', '07', '08', '09', '10', '11', '12', 'Admission', 'Special'] as $classOption)
                                <option value="{{ $classOption }}" {{ old('class', $student->class) == $classOption ? 'selected' : '' }}>
                                    Class {{ $classOption }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone_number" id="phone_number" class="form-control @error('phone_number') is-invalid @enderror" 
                               value="{{ old('phone_number', $student->phone_number) }}" placeholder="+880 1234567890">
                        @error('phone_number')
                            <span class="error-text">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="religion" id="religion" class="form-control @error('religion') is-invalid @enderror" 
                               value="{{ old('religion', $student->religion) }}" placeholder="e.g., Islam, Christianity">
                        @error('religion')
                            <span class="error-text">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="father_name" id="father_name" class="form-control @error('father_name') is-invalid @enderror" 
                                   value="{{ old('father_name', $student->father_name) }}" placeholder="Enter father's name">
                            @error('father_name')
                                <span class="error-text">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="father_phone" id="father_phone" class="form-control @error('father_phone') is-invalid @enderror" 
                                   value="{{ old('father_phone', $student->father_phone) }}" placeholder="+880 1234567890">
                            @error('father_phone')
                                <span class="error-text">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="mother_name" id="mother_name" class="form-control @error('mother_name') is-invalid @enderror" 
                                   value="{{ old('mother_name', $student->mother_name) }}" placeholder="Enter mother's name">
                            @error('mother_name')
                                <span class="error-text">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mother_phone" id="mother_phone" class="form-control @error('mother_phone') is-invalid @enderror" 
                                   value="{{ old('mother_phone', $student->mother_phone) }}" placeholder="+880 1234567890">
                            @error('mother_phone')
                                <span class="error-text">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="alt_guardian_name" id="alt_guardian_name" class="form-control @error('alt_guardian_name') is-invalid @enderror" 
                                   value="{{ old('alt_guardian_name', $student->alt_guardian_name) }}" placeholder="Optional">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="alt_guardian_phone" id="alt_guardian_phone" class="form-control @error('alt_guardian_phone') is-invalid @enderror" 
                                   value="{{ old('alt_guardian_phone', $student->alt_guardian_phone) }}" placeholder="Optional">
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                        ...
                        <textarea name="present_address" id="present_address" rows="3" class="form-control @error('present_address') is-invalid @enderror" 
                                  placeholder="Enter current address">{{ old('present_address', $student->present_address) }}</textarea>
